...
namespace osu.Game.Rulesets.Osu.Difficulty.Evaluators
{
    public static class SnapAimEvaluator
    {
        ...
        public static double EvaluateDifficultyOf(DifficultyHitObject current, bool withSliderTravelDistance)
        {
            ...
            double currVelocity = adjustSnapDistance(osuCurrObj.LazyJumpDistance, osuCurrObj) / osuCurrObj.AdjustedDeltaTime;
        ...
        private static double adjustSnapDistance(double currDistance, OsuDifficultyHitObject osuCurrObj)
        {
            ...
            if (osuCurrObj.AdjustedDeltaTime < strainTimeThreshold)
            {
                double bpmFactor = Math.Pow((strainTimeThreshold - osuCurrObj.AdjustedDeltaTime) * 0.015, 2.5);
