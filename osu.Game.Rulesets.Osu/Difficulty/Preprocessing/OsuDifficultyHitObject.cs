...
namespace osu.Game.Rulesets.Osu.Difficulty.Preprocessing
{
    public class OsuDifficultyHitObject : DifficultyHitObject
    {
        ...
        /// </para>
        /// </summary>
        public double NormalisedDistance { get; private set; }
        ...
        /// </summary>
        /// <remarks>
        /// This is bounded from above by <see cref="NormalisedDistance"/>, and is smaller than the former if a more natural path is able to be taken through the previous <see cref="OsuDifficultyHitObject"/>.
        /// </remarks>
        /// <example>
        /// Suppose a linear slider - circle pattern.
        /// <br />
        /// Following the slider lazily (see: <see cref="NormalisedDistance"/>) will result in underestimating the true end position of the slider as being closer towards the start position.
        /// As a result, <see cref="NormalisedDistance"/> overestimates the jump distance because the player is able to take a more natural path by following through the slider to its end,
        ...
        private void setDistances(double clockRate)
        {
            ...
            NormalisedDistance = (BaseObject.StackedPosition * scalingFactor - lastCursorPosition * scalingFactor).Length;
            MinimumJumpTime = StrainTime;
            MinimumJumpDistance = NormalisedDistance;
            ...
            if (lastObject is Slider lastSlider)
            {
                ...
                MinimumJumpDistance = Math.Max(0, Math.Min(NormalisedDistance - (maximum_slider_radius - assumed_slider_radius), tailJumpDistance - maximum_slider_radius));
            }
